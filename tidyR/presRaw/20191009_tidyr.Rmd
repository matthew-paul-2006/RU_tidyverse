...
---
# Lets get tidy!
__First step lets load in the data we are using today__
```{r}
cat(getwd())
...
__Which of our dataframes is tidy?__
...
---
## dplyr::select - (pt1)
__Select__ allows you to make a vector from a specific variable
```{r, echo=F, eval=T}
# Select one variable (common_name)
dplyr::select(df1, common_name)
```
```{r, echo=T, eval=F}
# Select one variable (common_name)
...
---
## dplyr::select - (pt2)
__Select__ allows you to make a dataframe from several variables
```{r}
# Select two variables (age_classbylength and common_name)
dplyr::select(df1, age_classbylength, common_name)
```

---
## dplyr::select - (pt3)
__Select__ allows you to make a dataframe excluding a variable
```{r}
...
---
## dplyr::select - (pt4)
__Select__ allows you to make a dataframe from a range of variables
```{r}
# Select all a range of contiguous varibles (common_name:length_mm)
dplyr::select(df1, common_name:length_mm)
```
...
dplyr::select(df1_A, age_classbylength, IGF1_ng_ml)
